...
<div class="portlet box green">
	...
	<div class="portlet-body flip-scroll">
		<table
			...
			<tr>
				<td><a href="balance_year.php?cmd=list" class="nav3">List</a>
					<form name="frm_balance_year" method="post"
        ...
        ?>
                    <select name="account_id" id="account_id"
                        ...
                        foreach ($resaccount as $key => $each) {
                            ?>
                          <option value="<?=$resaccount[$key]['id']?>"
        ...
        ?>
                        <select name="account_year_id"
									id="account_year_id" class="textbox">
										<option value="">--Select--</option>
                            <?php
                            foreach ($resyear as $key => $each) {
                                ?>
                              <option value="<?=$resyear[$key]['id']?>"
											<?php if($resyear[$key]['id']==$account_year_id){ echo "selected"; }?>><?=$resyear[$key]['']?></option>
                            <?php
                            }
                            ?> 
                        </select></td>
