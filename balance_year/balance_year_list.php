...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-globe"></i>Balance by Year (Openning Balance)
		</div>
					...
					<form name="search_frm" id="search_frm" method="post">
						<table width="60%" border="0" cellpadding="0" cellspacing="0"
							...
							<TR>
								<TD nowrap="nowrap">
					  <?php
    $hash = getTableFieldsName("balance_year");
    ...
    ?>
								...
								<td nowrap="nowrap" align="right"><input type="hidden"
									name="cmd" id="cmd" value="search_balance_year"> <input
			...
			<tr>
				<td>
					<!--<a href="balance_year.php?cmd=edit" class="nav3">Add a balance_year</a>-->
					<table
						class="table table-bordered table-striped table-condensed flip-content">
						<tr bgcolor="#ABCAE0">
							<td>Account</td>
...
for ($i = 0; $i < count($arr); $i ++) {
    ...
    ?>
							...
							<td nowrap><a
								href="balance_year.php?cmd=edit&id=<?=$arr[$i]['id']?>"
								class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								<a href="balance_year.php?cmd=delete&id=<?=$arr[$i]['id']?>"
...
?>
    ...
    $self = 'balance_year.php?cmd=list';
    $nav = '';
