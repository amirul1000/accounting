	...
	<div class="content">
		...
		<div class="alert alert-danger display-hide">
			...
			<div class="form-group">
				...
				<label class="control-label">User ID <font color="#FF0000">*</font></label>
			...
			<div class="form-group">
				...
				<input class="form-control form-control-solid placeholder-no-fix"
					...
					name="password" value="<?=$_REQUEST['password']?>" />
			</div>
			<!--<div class="form-group">
			<label class="control-label">Enter code <font color="#FF0000">*</font>  <img src="data:image/png;base64,<?=$capcha?>"/> </label>
