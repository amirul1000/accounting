...
<div class="portlet box green">
    ...
    ?>
								...
								<td nowrap="nowrap" align="right"><input type="hidden"
									name="cmd" id="cmd" value="search_users"> <input type="submit"
...
$whrstr .= " AND id='" . $_SESSION['user_id'] . "'";
    ...
    ?>
			<tr bgcolor="<?=$row?>"
			     ...
			     <?=$arr[$i]['first_name']?> <?=$arr[$i]['last_name']?>
							...
							<td nowrap><a href="users.php?cmd=edit&id=<?=$arr[$i]['id']?>"
								class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								<!--<a href="users.php?cmd=delete&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs black"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-trash-o"></i>Delete</a>-->
							</td>
