...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-globe"></i>Day Cash Statement
		</div>
				...
				<td>
					<form name="frm_cash_statement" method="post"
                        ...
                        <select name="account_id" id="account_id"
							...
							<tr>
								<td align="right"></td>
								<td><input type="hidden" name="cmd" value="statement_by_account">
				...
				<td>
					<form name="frm_cash_statement" method="post"
                        ...
                        <select name="head_id" id="head_id"
							...
							<tr>
								<td align="right"></td>
								<td><input type="hidden" name="cmd" value="statement_by_head"> <input
