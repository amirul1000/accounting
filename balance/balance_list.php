...
<div class="portlet box green">
					...
					<form name="search_frm" id="search_frm" method="post">
						<table width="60%" border="0" cellpadding="0" cellspacing="0"
							...
							<TR>
								<TD nowrap="nowrap">
					  <?php
    $hash = getTableFieldsName("balance");
    ...
    ?>
								...
								<td nowrap="nowrap" align="right"><input type="hidden"
									name="cmd" id="cmd" value="search_balance"> <input
			...
			<tr>
				<td>
					<!--<a href="balance.php?cmd=edit" class="btn btn-primary">Add a balance</a>-->
					<table
						class="table table-bordered table-striped table-condensed flip-content">
						<tr bgcolor="#ABCAE0">
							<td>Account</td>
...
for ($i = 0; $i < count($arr); $i ++) {
    ...
    ?>
							...
							<td nowrap>
								<!--<a href="balance.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a> 
				  <a href="balance.php?cmd=delete&id=<?=$arr[$i]['id']?>"  class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a>-->
							</td>
